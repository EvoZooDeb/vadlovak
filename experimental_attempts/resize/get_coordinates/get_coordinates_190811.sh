...
for i in /home/wildhorse_project/resized/resized_190811/*
do
...
while IFS= read -r coor; do
    ...
    if [[ frame_num -eq $valt ]]; then
        bool_test=1
        echo $coor >> "/home/wildhorse_project/resized/190811_coordinates.txt"
    else
        bool_test=0
    fi
...
done < "/home/wildhorse_project/horse_coordinates/horse_coordinates/190811_1/horse_coordinates.txt"